...
export class BrowserModelRuntime {
    ...
    layers;
    weightLoader;
    constructor(architecture, weights) {
     ...
     */
    async processLayer(layer, input) {
        switch (layer.type) {
            case 'linear':
     ...
     * Normalization layer
     */
    normalizationLayer(layer, input) {
     ...
     */
    generateRandomWeights(strategy = 'xavier') {
        const weights = {};
        for (const layer of this.layers) {
            if (layer.type === 'linear') {
                const weightSize = layer.inputSize * layer.outputSize;
     ...
     */
    calculateInitScale(inputSize, outputSize, strategy) {
        switch (strategy) {
            case 'xavier':
...
//# sourceMappingURL=browser-model-runtime.js.map