...
export class IPv6NeuralEncoder {
    ...
    // Reverse mappings
    static ACTIVATION_REVERSE = Object.fromEntries(Object.entries(IPv6NeuralEncoder.ACTIVATION_MAP).map(([k, v]) => [v, k]));
    static NORMALIZATION_REVERSE = Object.fromEntries(Object.entries(IPv6NeuralEncoder.NORMALIZATION_MAP).map(([k, v]) => [v, k]));
    /**
     ...
     */
    static createExampleArchitectures() {
        return [
            {
                modelFamily: 1,
                featureDim: 512,
...
//# sourceMappingURL=ipv6-encoder.js.map