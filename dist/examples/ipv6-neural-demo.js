 ...
 */
export function runIPv6NeuralDemo() {
    ...
    try {
        ...
        const roundTripValid = decodedGPT.modelFamily === gptArchitecture.modelFamily &&
    ...
    invalidIPv6Addresses.forEach((invalidAddr, index) => {
        try {
            ...
            console.log(`Invalid address ${index + 1} correctly rejected: ${error.message}`);
        }
    });
...
//# sourceMappingURL=ipv6-neural-demo.js.map