 ...
 */
export var GeometricType;
(function (GeometricType) {
    // 0D-2D (Local Context)
    GeometricType["POINT"] = "POINT";
    GeometricType["LINE"] = "LINE";
    GeometricType["TRIANGLE"] = "TRIANGLE";
    GeometricType["SQUARE"] = "SQUARE";
    // 3D Platonic Solids (Local Context)
    GeometricType["TETRAHEDRON"] = "TETRAHEDRON";
    GeometricType["CUBE"] = "CUBE";
    GeometricType["OCTAHEDRON"] = "OCTAHEDRON";
    GeometricType["DODECAHEDRON"] = "DODECAHEDRON";
    GeometricType["ICOSAHEDRON"] = "ICOSAHEDRON";
    // 4D Regular Polytopes (Federation Context)
    GeometricType["FIVE_CELL"] = "FIVE_CELL";
    GeometricType["EIGHT_CELL"] = "EIGHT_CELL";
    GeometricType["SIXTEEN_CELL"] = "SIXTEEN_CELL";
    GeometricType["TWENTY_FOUR_CELL"] = "TWENTY_FOUR_CELL";
    GeometricType["SIX_HUNDRED_CELL"] = "SIX_HUNDRED_CELL";
    // 3D Archimedean Solids (Global Context)
    GeometricType["TRUNCATED_TETRAHEDRON"] = "TRUNCATED_TETRAHEDRON";
    GeometricType["CUBOCTAHEDRON"] = "CUBOCTAHEDRON";
    GeometricType["TRUNCATED_CUBE"] = "TRUNCATED_CUBE";
    GeometricType["TRUNCATED_OCTAHEDRON"] = "TRUNCATED_OCTAHEDRON";
    GeometricType["RHOMBICUBOCTAHEDRON"] = "RHOMBICUBOCTAHEDRON";
    GeometricType["TRUNCATED_CUBOCTAHEDRON"] = "TRUNCATED_CUBOCTAHEDRON";
    GeometricType["SNUB_CUBE"] = "SNUB_CUBE";
    GeometricType["ICOSIDODECAHEDRON"] = "ICOSIDODECAHEDRON";
    GeometricType["TRUNCATED_DODECAHEDRON"] = "TRUNCATED_DODECAHEDRON";
    GeometricType["TRUNCATED_ICOSAHEDRON"] = "TRUNCATED_ICOSAHEDRON";
    GeometricType["RHOMBICOSIDODECAHEDRON"] = "RHOMBICOSIDODECAHEDRON";
    GeometricType["TRUNCATED_ICOSIDODECAHEDRON"] = "TRUNCATED_ICOSIDODECAHEDRON";
    GeometricType["SNUB_DODECAHEDRON"] = "SNUB_DODECAHEDRON";
 ...
 */
export function getGeometricShape(type) {
 ...
 */
export function calculateRequiredAgreement(shape) {
    return Math.ceil(shape.vertices * shape.threshold);
}
/**
 * Check if a shape is valid for consensus
 */
export function isValidForConsensus(shape, agreesCount) {
 ...
 */
export function getConsensusKeyword(shape) {
 ...
 */
export function findShapesByVertexRange(minVertices, maxVertices) {
    return Object.values(GEOMETRIC_SHAPES).filter(shape => shape.vertices >= minVertices && shape.vertices <= maxVertices);
}
/**
 * Get shapes suitable for a given number of participants
 */
export function getSuitableShapes(participantCount) {
    return Object.values(GEOMETRIC_SHAPES).filter(shape => shape.vertices >= participantCount).sort((a, b) => a.vertices - b.vertices);
}
//# sourceMappingURL=geometric-types.js.map