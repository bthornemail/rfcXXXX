 ...
 */
export function testBettiNumbers() {
    ...
    runTest('Single vertex', () => {
        const vertices = [{ id: 'v1', name: 'Vertex 1', connected: new Set() }];
        const edges = [];
        const betti = calculator.calculateBettiNumbers(vertices, edges);
    ...
    runTest('Partition detection edge cases', () => {
        const betti1 = { beta_0: 0, beta_1: 0, beta_2: 0 };
        const betti2 = { beta_0: 1, beta_1: 0, beta_2: 0 };
        const betti3 = { beta_0: 2, beta_1: 0, beta_2: 0 };
...
//# sourceMappingURL=betti-numbers.test.js.map