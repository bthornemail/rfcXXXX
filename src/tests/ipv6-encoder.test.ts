 ...
 */
export function testIPv6Encoder(): boolean {
  ...
  runTest('All activation functions', () => {
    const activations: NeuralArchitecture['activation'][] = ['relu', 'gelu', 'silu', 'tanh', 'linear'];
  ...
  runTest('All normalization types', () => {
    const normalizations: NeuralArchitecture['normalization'][] = ['layer', 'rms', 'batch', 'none'];
  ...
  runTest('Invalid input validation', () => {
    const invalidArchs = [
      { ...{} as NeuralArchitecture, modelFamily: -1 },
      { ...{} as NeuralArchitecture, modelFamily: 16 },
      { ...{} as NeuralArchitecture, featureDim: -1 },
      { ...{} as NeuralArchitecture, featureDim: 4096 },
      { ...{} as NeuralArchitecture, hiddenLayers: -1 },
      { ...{} as NeuralArchitecture, hiddenLayers: 16 },
      { ...{} as NeuralArchitecture, attentionHeads: -1 },
      { ...{} as NeuralArchitecture, attentionHeads: 256 },
      { ...{} as NeuralArchitecture, contextLength: -1 },
      { ...{} as NeuralArchitecture, contextLength: 2048 },
      { ...{} as NeuralArchitecture, vocabSize: -1 },
      { ...{} as NeuralArchitecture, vocabSize: 65536 },
      { ...{} as NeuralArchitecture, dropout: -0.1 },
      { ...{} as NeuralArchitecture, dropout: 1.1 },
      { ...{} as NeuralArchitecture, learningRate: -0.001 }
    ];
  ...
  runTest('Round-trip consistency', () => {
    const testArchitectures = [
      // GPT-like
      {
        ...
        activation: 'gelu' as const, normalization: 'layer' as const,
      ...
      // CNN-like
      {
        ...
        activation: 'relu' as const, normalization: 'batch' as const,
