 ...
 */
export function runGeometricConsensusDemo(): void {
  ...
  const tetrahedronVotes: DecisionVertex[] = [
  ...
  const octahedronVotes: DecisionVertex[] = [
  ...
  const cubeVotes: DecisionVertex[] = [
    { id: 'node1', name: 'Node 1', agrees: true, justification: 'Supports' },
    { id: 'node2', name: 'Node 2', agrees: true, justification: 'Agrees' },
    { id: 'node3', name: 'Node 3', agrees: true, justification: 'Votes yes' },
    { id: 'node4', name: 'Node 4', agrees: true, justification: 'In favor' },
  ...
  const fiveCellVotes: DecisionVertex[] = [
  ...
  const twentyFourCellVotes: DecisionVertex[] = Array.from({ length: 24 }, (_, i) => ({
    id: `fed${i + 1}`,
    name: `Fed Node ${i + 1}`,
  ...
  const truncatedTetrahedronVotes: DecisionVertex[] = Array.from({ length: 12 }, (_, i) => ({
    id: `global${i + 1}`,
  ...
  const customVotes: DecisionVertex[] = [
